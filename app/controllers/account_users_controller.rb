class AccountUsersController < ApplicationController
  ...
  def update
    if @account_user.update(account_user_params)
      ...
      notice_message = is_me ? "Your role has been updated." : "Updated #{@account_user.user.name}'s role."
  ...
  def destroy
    ...
    notice_message = is_me ? "You've been removed from the #{@account.name} team." : "Removed #{@account_user.user.name} from the #{@account.name} team."
